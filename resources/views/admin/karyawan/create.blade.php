...
@section('container')
    ...
    <div class="col-lg-8">
        <form method="POST" action="/admin/karyawan" class="mb-5" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
                <label for="NamaKaryawan" class="form-label">Nama Karyawan</label>
                <input type="text" class="form-control @error('NamaKaryawan') is-invalid @enderror" id="NamaKaryawan"
                    name="NamaKaryawan" required autofocus value="{{ old('NamaKaryawan') }}" autocomplete="off">
            ...
            <div class="mb-3">
                ...
                <select class="form-select @error('pekerjaan') is-invalid @enderror" name="pekerjaan" id="pekerjaan">
